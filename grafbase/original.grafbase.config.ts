// Original file given from https://www.npmjs.com/package/@grafbase/sdk 
// installed with `npx grafbase init --config-format typescript` cmd
// Covered at (38:52) https://youtu.be/986hztrfaSQ?t=2332
